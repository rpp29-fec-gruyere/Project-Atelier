    ...
    <div data-testid="ratingsBreakdown" className="ratingsBreakdown">
      ...
      <div id="ratingBarGraph">
        <div id="rating5" className="ratingBar component">
          ...
          <span className="ratingBar count">({metaData ? parseInt(metaData.ratings[5]) : 0})</span>
        </div>
        <div id="rating4" className="ratingBar component">
          ...
          <span className="ratingBar count">({metaData ? parseInt(metaData.ratings[4]) : 0})</span>
        </div>
        <div id="rating3" className="ratingBar component">
          ...
          <span className="ratingBar count">({metaData ? parseInt(metaData.ratings[3]) : 0})</span>
        </div>
