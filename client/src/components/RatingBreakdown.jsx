...
const RatingsBreakdown = props => {
  ...
  const handleFilterClick = ({target}) => {
    target.style.fontWeight === 'bold' ? target.style.fontWeight = 'normal' : target.style.fontWeight = 'bold';
    props.handleFilterChange(target);
  };
    ...
    <div data-testid="ratingsBreakdown" className="ratingsBreakdown" id="ratingBreakdown">
      ...
      <div id="ratingBarGraph">
        <div id="rating5" className="ratingBar component">
          <span className="ratingBar title" onClick={(e) => { handleFilterClick(e); }}>5 stars</span>
        ...
        <div id="rating4" className="ratingBar component">
          <span className="ratingBar title" onClick={(e) => { handleFilterClick(e); }}>4 stars</span>
        ...
        <div id="rating3" className="ratingBar component">
          <span className="ratingBar title" onClick={(e) => { handleFilterClick(e); }}>3 stars</span>
        ...
        <div id="rating2" className="ratingBar component">
          <span className="ratingBar title" onClick={(e) => { handleFilterClick(e); }}>2 stars</span>
        ...
        <div id="rating1" className="ratingBar component">
          <span className="ratingBar title" onClick={(e) => { handleFilterClick(e); }}>1 stars</span>
